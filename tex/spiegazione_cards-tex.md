Il file LaTeX `cards.tex` genera un layout di carte personalizzate, probabilmente per un gioco di ruolo o una collezione
di incantesimi. Di seguito è spiegato in dettaglio cosa fa:

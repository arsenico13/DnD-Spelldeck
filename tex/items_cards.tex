...
\usepackage{eso-pic}
\usepackage[paperheight=8.89cm,paperwidth=6.2cm,margin=0.6cm,top=22mm,bottom=10mm,headheight=1cm]{geometry}
    ...
    \AtPageLowerLeft{%
      ...
      \raisebox{10mm}[0pt][0pt]{%
        ...
        \parbox[b][\dimexpr\paperheight-63mm\relax][c]{\paperwidth}{%
          \centering
          \includegraphics[width=0.5\paperwidth]{images/roundpotioncol.png}%
        }%
      }%
    }%
  }%

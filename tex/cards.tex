...
\newenvironment{spell}[7]{
    ...
    \begin{minipage}[t]{0.49\textwidth}
        \centering\footnotesize\scshape{\color{headercolor}Cicci}

        \casttime
	\end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\textwidth}
        \centering\footnotesize\scshape{\color{headercolor}Balicci}

        \castrange
	\end{minipage}\\[3mm]
    \begin{minipage}[t]{0.49\textwidth}
        \centering\footnotesize\scshape{\color{headercolor}Pasticci}
